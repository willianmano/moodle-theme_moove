...
/**
 * Overriden course preview format renderer.
 *
 * @package    theme_moove
...
require_once($CFG->dirroot . '/course/format/preview/renderer.php');

/**
 * Rewrite format preview renderer base class
 *
 * @package    theme_moove
 * @copyright  2020 Willian Mano - http://conecti.me
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_moove_format_preview_renderer extends format_preview_renderer {
