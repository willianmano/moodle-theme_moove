...
class icon_system extends icon_system_font {
    ...
    public function get_core_icon_map() {
        return [
            ...
            'core:b/document-edit' => 'icon-pencil',
            ...
            'core:e/insert_page_break' => 'arrow-down-circle',
            ...
            'core:e/layers_under' => 'arrow-down-circle',
            ...
            'core:e/page_break' => 'arrow-down-circle',
            ...
            'core:e/special_character' => 'icon-pencil-square-o',
            ...
            'core:i/assignroles' => 'icon-user-follow',
            ...
            'core:i/enrolusers' => 'icon-user-follow',
            ...
            'core:i/loading_small' => 'fa-spinner fa-spin',
            'core:i/lock' => 'fa-lock',
            ...
            'core:i/permissions' => 'icon-pencil-square-o',
            ...
            'core:i/risk_managetrust' => 'icon-exclamation text-warning',
            'core:i/risk_personal' => 'icon-exclamation text-info',
            'core:i/risk_spam' => 'icon-exclamation text-primary',
            'core:i/risk_xss' => 'icon-exclamation text-danger',
            ...
            'core:t/enrolusers' => 'icon-user-follow',
            ...
            'core:t/restore' => 'icon-arrow-up-circle',
