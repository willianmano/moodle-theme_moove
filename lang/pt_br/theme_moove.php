...
$string['favicondesc'] = 'Envie seu próprio favicon. O arquivo deve ter a extensão .ico.';
...
$string['navbarbg'] = 'Cor de fundo do menu lateral';
$string['navbarbg_desc'] = 'Cor de fundo do menu lateral';
$string['navbarbghover'] = 'Cor de fundo do menu lateral ao passar mouse';
$string['navbarbghover_desc'] = 'Cor de fundo do menu lateral ao passar o mouse sobre';
...
$string['websitedesc'] = 'Link do site principal da empresa';
